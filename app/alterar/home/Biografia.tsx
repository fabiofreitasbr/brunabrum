    ...
    return (
        <div className="bg-neutral-100 bg-no-repeat">
            <div className="container mx-auto px-4 ">
                <h2 className="text-azul-500 font-bodoni xl:text-5xl 2xl:text-6xl text-center pt-[77px] pb-[19px]">BIOGRAFIA</h2>
                <div className="flex">
                    <div className=" w-1/2 mx-auto xl:text-xl 2xl:text-2xl  py-[60px] text-textBio">
                        <p className="pb-8 "><span className="font-bold">Bruna Brum</span> é uma jovem cantora gospel de 19 anos, residente <br /> em Queimados, RJ. </p>
                        <p className="pb-8 ">Desde a infância, Bruna tem <span className="font-bold">dedicado sua vida à música e ao</span> <br />
                        ...
                        <p className="pb-8">Ela congrega na Igreja Assembleia de Deus Vida na Palavra<br />
