                ...
                <div className="grid gap-y-4 md:gap-y-6 ">
                    {
                        redesLista.map((singleLista) => (
                            <div key={singleLista.title} className="text-convite bg-gray-100 px-2 py-4 sm:px-8 md:px-8 md:py-4 lg:px-10 lg:py-6 text-base md:text-2xl lg:text-4xl rounded-2xl transition ease-in-out hover:scale-105 hover:bg-blue-500 hover:text-white duration-300">
