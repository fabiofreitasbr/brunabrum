...
export default function Banner() {
    return (
        <div className="bg-banner bg-cover bg-bottom w-full pt-14 -mb-10 min-h-[20rem]">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center">
                        <div className="text-azul-500 md:mb-14">
                            <h2 className="text-center md:text-left text-[2rem] md:text-[2.5rem] lg:text-[5rem] text-azul-500 font-bodoni grow uppercase">{ContentLinks.titleSite}</h2>
